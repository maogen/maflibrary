...
import com.tgram.qrcode.decoding.CaptureActivityHandler;
import com.tgram.qrcode.decoding.InactivityTimer;
import com.tgram.qrcode.view.ViewfinderView;
 ...
 * 2：在Manifest里面注册Activity：android:name="com.tgram.qrcode.CaptureActivity"
 * 3：在onActivityResult里面进行回调的处理：String code = intent.getStringExtra(SysCodeZxing.CODE_RESULT_KEY);
 */
public class ActivityCapture extends AppCompatActivity implements Callback {

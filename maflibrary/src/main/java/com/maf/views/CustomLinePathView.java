...
public class CustomLinePathView extends View {
    ...
    public CustomLinePathView(Context context) {
        super(context);
        init(context);
    }

    public CustomLinePathView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public CustomLinePathView(Context context, AttributeSet attrs, int defStyleAttr) {
